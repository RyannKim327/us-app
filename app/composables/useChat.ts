...
const MOCK_USERS: User[] = [
  { id: 'u1', username: 'Sarah Connor', email: 'sarah@usapp.io', avatar: '👩‍💻', status: 'online', statusText: 'Coding in Nuxt...' },
...
const MOCK_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    senderAvatar: '👩‍💻',
    content: 'Hey Jarvis! Working on a new Nuxt web application today. The client-side state is running beautifully.',
  ...
  },
  {
    ...
    senderName: 'Sarah Connor',
    senderAvatar: '👩‍💻',
    content: 'Nuxt 3 composition API combined with Tailwind CSS makes prototyping super fast.',
